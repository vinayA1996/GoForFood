...
export class MenuComponent implements OnInit {
  ...
  constructor(private main: MainService, private favorite: FavoriteService, private cart: CartService, private route: RouteService, private snackBar: MatSnackBar) { }

  ngOnInit(): void {
    this.city = window.localStorage.getItem('city');
    this.restaurant = window.localStorage.getItem('restaurant');
